  ...
  render() {
    const author = (
      <div>
        ...
        <p>
          Hi! I'm a programmer currently living in Indiana. I'm passionate about
          video games, music, and how programming intersects the two. Here are
          the projects I've worked on along with tutorials and other various
          blog posts.{' '}
          <Link
            to="/about/"
            css={{
